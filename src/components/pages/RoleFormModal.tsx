...
export default function RoleFormModal({ role, onClose, onSave }: { role?: any, onClose: () => void, onSave: (data: any) => void }) {
      ...
      <div className="bg-white rounded-xl max-w-lg w-full">
        <form onSubmit={handleSubmit}>
          <div className="p-6 border-b flex justify-between items-center">
            <h2 className="text-xl font-bold">{role ? 'Editar Função' : 'Adicionar Nova Função'}</h2>
          ...
          <div className="p-6 space-y-4">
            ...
            <div>
              ...
              <textarea name="description" value={formData.description} onChange={handleChange} rows={3} className="w-full p-2 border rounded-lg" required></textarea>
            </div>
          </div>
