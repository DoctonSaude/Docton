...
export default function UserFormModal({ user, onClose, onSave }: { user?: any, onClose: () => void, onSave: (data: any) => void }) {
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select name="plan" value={formData.plan} onChange={handleChange} className="w-full p-2 border rounded-lg bg-white" required>
