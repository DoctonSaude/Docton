...
export default function ServiceUploadModal({ onClose, onUpload }: { onClose: () => void, onUpload: (file: File) => void }) {
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6 border-b flex justify-between items-center">
            <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2">
              ...
              Importar Tabela de Serviços
            </h2>
            <button type="button" onClick={onClose} className="p-2 text-gray-400 hover:text-gray-600 rounded-full"><X/></button>
          </div>
          <div className="p-6 space-y-4">
            <p className="text-sm text-gray-600">
              Selecione um ficheiro CSV para adicionar ou atualizar os seus serviços em massa. O ficheiro deve conter as colunas: <strong>nome, categoria, preco_base, duracao_minutos</strong>.
            </p>
            {!file ? (
